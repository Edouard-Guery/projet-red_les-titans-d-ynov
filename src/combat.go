...
func (p *Personnage) utiliserObjetdurantcombat(m *Monstre) bool {
	...
	for nom, qte := range p.Inventaire {
		...
		if qte > 0 && (nom == "Potion de vie (+)" || nom == "Potion de vie (++)" || nom == "Potion d'attaque (+)" || nom == "Potion de défense (+)" || nom == "Potion de poison (+)" || nom == "Potion de poison (++)" || nom == "Potion d'endurance (+)" || nom == "Potion d'endurance (++)") {
	...
	case "Potion d'endurance (+)":
		...
		p.PotionEndurancePlus()

		fmt.Println(Cyan + "⚡ Vous avez bu une Potion d'endurance (+) (+25 ⚡) !" + Reset)

	case "Potion d'endurance (++)":

		p.PotionEndurancePlusPlus()

		fmt.Println(Cyan + "⚡ Vous avez bu une Potion d'endurance (++) (+60 ⚡) !" + Reset)
